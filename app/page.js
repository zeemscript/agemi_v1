...
export default function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-[#0B1120] via-[#0F172A] to-[#0B1120] flex items-center justify-center text-center px-6 overflow-hidden">
      ...
      >
        ...
        <p className="mt-6 text-lg md:text-xl lg:text-2xl text-slate-300 max-w-2xl sm:max-w-3xl mx-auto font-light font-stretch-125%">
          Real-time visibility, API protection, and WAF intelligence in a single
          dashboard. Stay ahead of threats with unmatched security insights.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-5">
          ...
          <Button round className="bg-transparent border border-cyan-400 hover:bg-cyan-400/10 text-cyan-300 px-8 py-3 text-lg">
            Watch Demo
          </Button>
        </div>
      </motion.div>
